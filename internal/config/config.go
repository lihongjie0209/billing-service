...
func setDefaults(v *viper.Viper) {
	...
	v.SetDefault("database.schema", "billing")
	...
	v.SetDefault("jwt.issuer", "billing-service")
	...
	v.SetDefault("auth.audience", "billing-service")
	...
	v.SetDefault("migration.table", "billing_schema_migrations")
...
func (c Config) Validate() error {
	...
	if c.App.Env == "production" && (c.Auth.JWKSURL == "" || c.Auth.Issuer == "" || c.Auth.Audience == "") {
		return errors.New("production authentication requires identity JWKS URL, issuer, and billing-service audience")
	}
