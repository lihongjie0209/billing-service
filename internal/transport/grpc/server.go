...
func NewServer(lc fx.Lifecycle, cfg config.Config, authService *auth.Service, authorizer platformauthz.Authorizer, healthService *apphealth.Service, billingService *billing.Service, metrics *observability.Metrics, logger *slog.Logger) (*Server, error) {
