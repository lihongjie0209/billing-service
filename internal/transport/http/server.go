...
import (
	...
	docs "github.com/lihongjie0209/billing-service/docs"
	...
	"github.com/lihongjie0209/billing-service/internal/health"
	"github.com/lihongjie0209/billing-service/internal/observability"
	"github.com/lihongjie0209/billing-service/internal/ratelimit"
...
func NewServer(lc fx.Lifecycle, cfg config.Config, handler *Handler, authService *auth.Service, authorizer platformauthz.Authorizer, limiter *ratelimit.Limiter, metrics *observability.Metrics, tracing *observability.Tracing, logger *slog.Logger) (*http.Server, error) {
	...
	registerBillingRoutes(api, handler)
