...
func NewHandler(healthService *health.Service, billingService *billing.Service, logger *slog.Logger) *Handler {
	return &Handler{health: healthService, billing: billingService, logger: logger}
}
